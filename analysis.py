...
df_doh = pd.read_csv('AI_analysis/CSVs/Total_CSVs/l1-doh.csv')
df_non_doh = pd.read_csv('AI_analysis/CSVs/Total_CSVs/l1-nondoh.csv')
df_benign = pd.read_csv('AI_analysis/CSVs/Total_CSVs/l2-benign.csv')
df_malicious = pd.read_csv('AI_analysis/CSVs/Total_CSVs/l2-malicious.csv')
...
print(merged_df.shape[0])
print(merged_df.shape[1])
merged_df.to_csv('AI_analysis/merged_sample.csv', index=False)